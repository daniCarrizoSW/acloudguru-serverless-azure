// topic Endpoint: https://acg-eg-dc.brazilsouth-1.eventgrid.azure.net/api/events
...
function publishToEventGrid(speaker) {
    ...
    const topicHostName = "https://acg-eg-dc.brazilsouth-1.eventgrid.azure.net/api/events";
    let data = speaker;
    let events = [
        {
            id: uuid(),
